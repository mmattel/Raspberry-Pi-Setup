...
# when running: python -m pip install -r requirements.txt'
# you mey get errors because modules are already existing in your environment.
# this script prints all moudules that should be commented in a requirements.txt file
# for an error free install.
...
# print the modules to be commented
print()
